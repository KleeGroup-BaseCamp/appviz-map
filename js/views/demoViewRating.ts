...
export class DemoViewRating implements View {
    ...
    public provideLayers(modelRepository: ModelRepository, layout: Layout): Layer[] {
        ...
        return  [
            ...
            .addElement(new HeartRating2("-1", pxSize, 0), new PxPosition(100,200))
            .addElement(new HeartRating2("-1", pxSize, 1), new PxPosition(250,200))
            .addElement(new HeartRating2("-1", pxSize, 2.5), new PxPosition(400,200))
            .addElement(new HeartRating2("-1", pxSize, 3), new PxPosition(550,200))
            .addElement(new HeartRating2("-1", pxSize, 4.2), new PxPosition(700,200))
            .addElement(new HeartRating2("-1", pxSize, 5), new PxPosition(850,200))
            .addElement(new StarRating2("-1", pxSize, 0), new PxPosition(100,250))
            .addElement(new StarRating2("-1", pxSize, 1), new PxPosition(250,250))
            .addElement(new StarRating2("-1", pxSize, 2.5), new PxPosition(400,250))
            .addElement(new StarRating2("-1", pxSize, 3), new PxPosition(550,250))
            .addElement(new StarRating2("-1", pxSize, 4.2), new PxPosition(700,250))
            .addElement(new StarRating2("-1", pxSize, 5), new PxPosition(850,250))
